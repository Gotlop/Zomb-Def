// Pastikan semua kode berjalan setelah DOM dimuat
window.onload = function () {
  ...
  // Fungsi untuk menggambar zombie
  ...
  // Fungsi untuk menggambar skor dan nyawa
  function drawScore() {
    ctx.fillStyle = "white";
    ctx.font = "20px Arial";
  ...
  // Fungsi untuk menggerakkan zombie menuju pemain
  ...
  // Mulai spawn zombie setiap 2 detik
